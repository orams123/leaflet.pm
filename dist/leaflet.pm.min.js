! function(t) {
    ...
    t.exports = {
        tooltips: {
            placeMarker: "לחץ להצבת סמן",
            firstVertex: "לחץ על מנת להציב את הנקודה הראשונה",
            continueLine: "לחץ על הנקודה הבאה",
            finishLine: "המשך או לחץ פעמיים לסיום",
            finishPoly: "המשך או לחץ על הנקודה הראשונה לסיום",
            finishRect: "לחץ לסיום",
            startCircle: "לחץ להצבת מרכז המעגל",
            finishCircle: "לחץ להשלמת המעגל",
            placeCircleMarker: "Click to place circle marker"
        },
        actions: {
            finish: "סיום",
            cancel: "ביטול",
            removeLastVertex: "מחק את הנקודה האחרונה"
        },
        buttonTitles: {
            drawMarkerButton: "הצב סמן",
            drawPolyButton: "צייר פוליגון סגור",
            drawLineButton: "צייר פוליגון פתוח",
            drawCircleButton: "ציר מעגל",
            drawRectButton: "צייר מרובע",
            editButton: "ערוך אוביקט",
            dragButton: "הזז אוביקט ",
            cutButton: "Cut Layers",
            deleteButton: "מחק אוביקט",
